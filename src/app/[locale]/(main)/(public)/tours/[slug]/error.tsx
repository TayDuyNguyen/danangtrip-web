    ...
    <div className="design-page layout-main-shell min-h-screen pb-20">
      <div className="design-container pt-28 md:pt-32">
        <div className="glass-shell max-w-2xl mx-auto">
          <div className="glass-inner bg-surface-container-low p-8 md:p-10 text-on-surface-subtleenter space-y-4">
            <h1 className="text-on-surfacexl md:text-on-surface-subtlexl font-black text-on-surface">
              {td("error_title")}
            </h1>
