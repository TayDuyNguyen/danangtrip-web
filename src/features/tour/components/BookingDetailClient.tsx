      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-6 print:hidden">
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            className={`px-5 py-2.5 rounded-full text-xs font-semibold text-white border-border bg-surface-container hover:border-primary/50 flex items-center gap-2 transition-all duration-200 ${
          ...
          >
            ...
            <span>{isDownloading ? t("invoice_downloading") : t("button_print_invoice")}</span>
          </Button>
