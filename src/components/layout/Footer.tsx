...
const Footer = () => {
  ...
  return (
    <footer className="relative mx-auto mb-6 w-[calc(100%-2rem)] select-none overflow-hidden rounded-[28px] border border-border bg-white px-6 pb-10 pt-16 text-on-surface shadow-[0_24px_80px_rgba(15,23,42,0.08)] md:w-[calc(100%-3rem)] md:px-16 lg:w-[calc(100%-4rem)]">
