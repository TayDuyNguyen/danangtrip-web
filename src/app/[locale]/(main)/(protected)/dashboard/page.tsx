...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-surface-container-low p-10 rounded-xl border border-border mb-10 overflow-hidden relative group">
        ...
        <div className="relative z-10">
          <p className="text-on-surfacexl text-[#d4d4d4] leading-relaxed font-medium">
            {t("dashboard.welcome")}, <span className="font-bold text-primary">{user?.name || t("auth.profile")}</span>!
          </p>
          <p className="text-lg text-[#a3a3a3] mt-2">
            {t("dashboard.personal_page_desc")}
          </p>

          <div className="mt-8 flex items-center gap-3 p-4 bg-surface-container-highest rounded-lg border border-border max-w-fit">
            <IoRocketOutline className="text-xl text-primary animate-pulse" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="bg-surface-container-low p-8 rounded-xl border border-border transition-shadow">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 bg-[#1a1f14] rounded-lg flex items-center justify-center">
              <IoShieldCheckmarkOutline className="text-on-surfacexl text-[#929852]" />
            </div>
            <div>
        ...
        <div className="bg-surface-container-low p-8 rounded-xl border border-border transition-shadow">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 bg-surface-container-highest rounded-lg flex items-center justify-center">
              <IoFingerPrintOutline className="text-on-surfacexl text-primary" />
            </div>
            <div>
              <h3 className="text-xs font-bold text-[#737373] uppercase tracking-widest">
