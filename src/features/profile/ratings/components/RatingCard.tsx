...
export function RatingCard({
  ...
  return (
    <article className="animate-in fade-in slide-in-from-bottom-4 rounded-[20px] border border-border bg-white p-5 shadow-[0_1px_3px_rgba(0,0,0,0.08)] transition-all duration-300 hover:border-primary/30 hover:shadow-[0_8px_16px_rgba(0,0,0,0.12)]">
      {/* Header section */}
          ...
          <div>
            ...
            {rating.comment.length > 200 && (
              <button
                ...
                className="text-xs font-bold text-primary hover:text-[#e31c5f] transition-colors mt-1 focus:outline-none"
              >
