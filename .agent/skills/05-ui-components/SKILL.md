...
- When building new UI components or refactoring an existing screen structure.
- When you need a clear reuse/new/modify breakdown before coding.
- When reviewers need a component-level plan tied to the real design system.
